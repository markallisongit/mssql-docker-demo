        ...
        switch ($ContainerType)
        {
            ...
            'Linux' {
                if (([string]::IsNullOrEmpty($KeyFilePath)) -or ([string]::IsNullOrEmpty($DockerUserName)))
                {
                    ...
                    $output = New-LinuxMssqlContainer -DockerHost $DockerHost -SaPassword $SaPassword -StartPortRange $StartPortRange -KeyFilePath $KeyFilePath -DockerUserName $DockerUserName
                }
            }
